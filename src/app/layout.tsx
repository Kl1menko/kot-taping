      ...
      <body className="min-h-dvh antialiased">
        ...
        */}
        ...
        {/*
          ...
          Місце — всередині <body>, а не між ним і </html>: там жоден елемент
          не має стояти за специфікацією. React такий вміст усе одно інжектує,
          тож помітного збою не було й ніхто цього не бачив, — але тримати
          розмітку в стані, який рятує лише поблажливість рендерера, значить
          чекати на тихий злам при оновленні React чи Next.
        */}
