...
/**
 * Серверний запобіжник 5 МБ. Інтерфейс приймає оригінал до 15 МБ і стискає
 * великі фото до 4 МБ перед надсиланням: Vercel обмежує запит до 4,5 МБ.
 * Bucket лишається з лімітом 5 МБ, бо зберігає вже підготовлений файл.
 */
