...
const nextConfig: NextConfig = {
  images: {
    ...
    /**
     * Ширини під реальні картки, а не під гіпотетичний 4K-монітор.
     *
     * За замовчуванням Next пропонує `srcset` аж до 3840px. Наші вихідники —
     * 800–900px завширшки (фото послуг, галерея, колажі «до/після»), тож усе
     * вище 828 віддає той самий байт-у-байт файл: апскейлу немає, а браузер
     * на Retina цілком може попросити 1920 чи 3840 і чекати кодування, яке
     * нічого не змінить.
     *
     * 1080 лишаємо стелею: під нього підпадає герой на весь екран, який
     * єдиний справді буває широким. 2048 і 3840 прибрані — жодне наше фото
     * не має стільки пікселів, щоб їх заповнити.
     *
     * `imageSizes` — для картинок із `sizes` (усі картки): 400 закриває
     * картку в одну колонку на телефоні, 300 — дві колонки на планшеті.
     * Усі значення менші за найменше з `deviceSizes`, як вимагає Next.
     */
    deviceSizes: [640, 750, 828, 1080],
    imageSizes: [128, 200, 256, 300, 400],
